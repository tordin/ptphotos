...
%>
	{ "picture_id":"<%= offset + i + 1 %>", "picture_url":"http://tordin.fortis4.com/ptphotos/server/images/pic<%= i + 1 %>.jpg", "thumb_url":"http://tordin.fortis4.com/ptphotos/server/images/pic<%= i + 1  %>.jpg", "date":"2012-08-23" }<%= i < length - 1 ? "," : "" %>
<%
}
%>
] }
