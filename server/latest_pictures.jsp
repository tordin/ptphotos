...
%>
	{ "picture_id":"<%= offset + i %>", "picture_url":"http://tordin.fortis4.com/ptphotos/server/images/pic<%= i %>.jpg", "thumb_url":"http://tordin.fortis4.com/ptphotos/server/images/pic<%= i %>.jpg", "date":"2012-08-23" }<%= i < length - 1 ? "," : "" %>
<%
}
%>
] }
